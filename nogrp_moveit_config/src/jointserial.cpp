...
unsigned char aa;
//回调函数
void write_callback(const nogrp_moveit_config::joint_msg::ConstPtr& msg)
{
...
int main (int argc, char** argv)
{
    ...
    //发布主题
    ros::Publisher joint_motor_pub = nh.advertise<nogrp_moveit_config::joint_msg>("/arm_motors", 1000);
