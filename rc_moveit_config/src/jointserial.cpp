...
#include <rc_moveit_config/joint_msg.h>
...
unsigned char aa;
//回调函数
void write_callback(const rc_moveit_config::joint_msg::ConstPtr& msg)
{
...
int main (int argc, char** argv)
{
    ...
    //发布主题
    ros::Publisher joint_motor_pub = nh.advertise<rc_moveit_config::joint_msg>("/arm_motors", 1000);
    rc_moveit_config::joint_msg joint_motor_msg;
